...
class MigrateUsersByEmail extends BooleanSetting implements ISettingPaths, IOverwriteGlobal {
	...
	public function getLabelMessageKey() {
		return 'bs-distributionconnector-pref-openidconnect-migrateusersbyemail';
	}
	...
	public function getGlobalName() {
		return "wgOpenIDConnect_MigrateUsersByEmail";
	}
}
