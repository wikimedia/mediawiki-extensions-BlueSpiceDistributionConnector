...
class UseRealNameAsUserName extends BooleanSetting implements ISettingPaths, IOverwriteGlobal {
	...
	public function getLabelMessageKey() {
		return 'bs-distributionconnector-pref-openidconnect-userealnameasusername';
	}
	...
	public function getGlobalName() {
		return "wgOpenIDConnect_UseRealNameAsUserName";
	}
}
