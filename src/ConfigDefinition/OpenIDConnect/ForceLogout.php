...
class ForceLogout extends BooleanSetting implements ISettingPaths, IOverwriteGlobal {
	...
	public function getLabelMessageKey() {
		return 'bs-distributionconnector-pref-openidconnect-forcelogout';
	}
	...
	public function getGlobalName() {
		return "wgOpenIDConnect_ForceLogout";
	}
}
