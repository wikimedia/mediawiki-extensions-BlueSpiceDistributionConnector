...
class MigrateUsersByUserName extends BooleanSetting implements ISettingPaths, IOverwriteGlobal {
	...
	public function getLabelMessageKey() {
		return 'bs-distributionconnector-pref-openidconnect-migrateusersbyusername';
	}
	...
	public function getGlobalName() {
		return "wgOpenIDConnect_MigrateUsersByUserName";
	}
}
